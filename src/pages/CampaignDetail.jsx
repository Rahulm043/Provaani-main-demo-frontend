            ...
            <div className="page-header flex-between">
                <div>
                    ...
                    <p className="flex-center gap-1">
                        ...
                        <span className="badge" style={{ background: 'rgba(255,255,255,0.04)' }}>auto scheduled</span>
                        <span className="badge" style={{ background: 'rgba(255,255,255,0.04)' }}>5 global slots</span>
                        <span className="badge" style={{ background: 'rgba(255,255,255,0.04)' }}>15s cooldown</span>
                        ...
                        {campaign.scheduled_at && <span className="text-dim text-sm">• Scheduled {formatDate(campaign.scheduled_at)}</span>}
                    </p>
                </div>
